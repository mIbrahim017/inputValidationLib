...
public class MainActivity extends AppCompatActivity implements ValidationExecutor.ValidationListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        validationExecutor = new ValidationExecutor(this);
    ...
    public void onValidatePass() {
        uiValidation.setValidationPass();
    ...
    @Override
    public void onValidationFail(FieldValidator field, IValidator iValidator) {
        uiValidation.setValidationUI(field, iValidator);
